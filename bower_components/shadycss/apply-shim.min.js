(function () {
  ...
  */
  ...
  function y(a, b) {
    ...
    if (c = a.rules) for (var e = 0, d = c.length, f = void 0; e < d && (f = c[e]); e++) y(f, b);
    return a;
  }
  ...
  function E(a, b, c) {
    ...
    if (a.cssText || a.rules) {
      ...
      if (f) {
        ...
        for (var g = d.length, h = void 0; f < g && (h = d[f]); f++) e = E(h, b, e);
  ...
  function L(a, b, c, e) {
    if (a) {
      ...
      if ((a = a.rules) && !d) for (d = 0, f = a.length, g = void 0; d < f && (g = a[d]); d++) L(g, b, c, e);
    }
  }
  ...
  function S(a, b, c) {
    for (var e; e = H.exec(b);) {
      ...
      if (m) {
        ...
        for (d in q) k = h && h[d], m = [d, ": var(", f, "_-_", d], k && m.push(",", k.replace(O, "")), m.push(")"), O.test(q[d]) && m.push(" !important"), n.push(m.join(""));
      }
  ...
  function T(a, b, c) {
    ...
    for (var e, d, f = {}, g = 0, h; g < b.length; g++) if (e = b[g]) if (h = e.split(":"), 1 < h.length) {
      e = h[0].trim();
      d = h.slice(1).join(":");
